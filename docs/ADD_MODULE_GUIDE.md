...
Also run `prettier -w .` on the pipeline directory to lint with [prettier](https://nf-co.re/docs/contributing/code_editors_and_styling/code_formatting#prettier).
