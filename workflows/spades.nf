...
workflow SPADES {
    ...
    MLST_MLST (
        POLISH_ASSEMBLY_BWA_PILON.out.bam.join(POLISH_ASSEMBLY_BWA_PILON.out.assembly)
    )
    ...
    EXTRACT_16S_BIOPYTHON (
        ANNOTATE_PROKKA.out.annotation.join(POLISH_ASSEMBLY_BWA_PILON.out.assembly)
    )
    ...
    EXTRACT_16S_BARRNAP (
        ANNOTATE_PROKKA.out.annotation.join(POLISH_ASSEMBLY_BWA_PILON.out.assembly).join(EXTRACT_16S_BIOPYTHON.out.extracted_rna)
    )
    ...
    ALIGN_16S_BLAST (
        EXTRACT_16S_BARRNAP.out.extracted_base.join(POLISH_ASSEMBLY_BWA_PILON.out.assembly)
    )
    ...
    BEST_16S_BLASTN_BITSCORE_TAXON_PYTHON (
        ALIGN_16S_BLAST.out.blast_tsv.join(POLISH_ASSEMBLY_BWA_PILON.out.assembly)
    )
    ...
    QA_ASSEMBLY_QUAST (
        OVERLAP_PAIRED_READS_FLASH.out.gzip_reads.join(POLISH_ASSEMBLY_BWA_PILON.out.assembly)
    )
