...
class NfcoreTemplate {
    ...
    //
    // wf-paired-end-illumina-assembly logo
    //
    public static String logo(workflow, monochrome_logs) {
        ...
        String.format(
            ...
            ${colors.blue}|  ||_  __ |__) /\\ ||__)|_ |  \\ __ |_ |\\ ||  \\ __ ${colors.reset}
            ${colors.blue}|/\\||      |   /--\\|| \\ |__|__/    |__| \\||__/    ${colors.reset}
            ${colors.blue}                                 __ __ __     __       ${colors.reset}
            ${colors.blue}||  |  |  ||\\/|||\\ | /\\  __  /\\ (_ (_ |_ |\\/||__)|  \\_/ ${colors.reset}
